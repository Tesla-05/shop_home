...
class CartChangeView(CartMixin, View):
    def post(self, request):
        ...
        response_data = {"message": "Количество изменено", "quantity": quantity, "cart_items_html": self.render_cart(request)}
...
class CartRemoveView(CartMixin, View):
    def post(self, request):
        ...
        response_data = {"message": "Товар удален из корзины", "quantity_deleted": quantity, "cart_items_html": self.render_cart(request)}
...
#     response_data = {"message": "Количество изменено", "quantity": quantity, "cart_items_html": cart_items_html}
